...
-- Piety from giving titles to the Church or Holy Orders
	...
	EMPEROR_GRANT_TO_CHURCH_PIETY = 400,
...
NReligion = {
	...
	CREATE_ANTIPOPE_AUTHORITY_LOSS = 0.4,
	ANTIPOPE_MONTHLY_AUTHORITY_LOSS = 0.0,
...
NEconomy = {
	...
	REPUBLIC_CITY_TAX_BONUS = 0.125,						-- Republics (at least Count tier) receive a tax bonus for all cities in their realm
	REPUBLIC_COASTAL_CITY_TAX_BONUS = 0.125,		-- Republics (at least Count tier) receive a tax bonus for all coastal cities in their realm
	REPUBLIC_CAPITAL_CITY_TAX_BONUS = 0.5,		-- Duke or above tier Republics receive a tax bonus for their capital city
...
NAI =
{
	...
	DOW_AGGRESSION_FACTOR = 1.0,							-- General aggressiveness declarations of war
	REVOLT_AGGRESSION_FACTOR = 1.0,						-- General aggressiveness for revolts against the liege
