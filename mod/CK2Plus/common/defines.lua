...
NDiplomacy = {
	...
	SEND_GIFT_INCOME_SCALEFACTOR = 12, 
	...
	DEMESNE_MAX_SIZE_STEWARDSHIP_MULT = 0.10, -- Extra Max Demesne Size from ruler and spouse intrigue
	DEMESNE_MAX_SIZE_LEGALISM_MULT = 1.0, -- Extra Max Demesne Size from the level of legalism
	GAVELKIND_MAX_SIZE_BONUS = 0.34,		-- Max demesne size bonus from Gavelkind
	...
	REVOKE_TITLE_INTERACTION_PRESTIGE = 100,
...
NCharacter = {
	...
	PRESTIGE_FROM_DYNASTY_ON_BIRTH_DIV = 25, -- Newly born characters get the dynasty prestige of their mother and father divided by this as their starting prestige
	PRESTIGE_FROM_DYNASTY_ON_MARRIAGE_DIV = 50, -- Characters get the dynasty prestige of the spouse divided by this on marriage
...
-- Monthly prestige LOSS from each unlanded adult son
	...
	EMPEROR_LANDLESS_SON_PRESTIGE = 2.0,
...
NReligion = {
	...
	POPE_DIPLO_TO_AUTHORITY_DIV = 20000,
	EXCOM_MIN_AUTHORITY = 0.3,
	INVASION_MIN_AUTHORITY = 0.5,
	KINGDOM_CREATION_PIETY_COST = 100,
...
NMilitary = {
	...
	GARRISON_REINFORCE_RATE_MULTIPLIER = 50,			-- The rate at which the garrison reinforce
	...
	CAPITAL_WARSCORE_MULTIPLIER = 3,				-- Warscore multiplier for capital(this is scaled with SETTLEMENT_WARSCORE_MULTIPLIER)
	SETTLEMENT_WARSCORE_MULTIPLIER = 0.4,			-- Warscore worth for occupied private demesne
	VASSAL_SETTLEMENT_WARSCORE_MULTIPLIER = 0.4,	-- Warscore worth for occupied vassals
	CONTESTED_TERRITORY_WARSCORE_MULTIPLIER = 1.5,	-- Multiplier for contested settlements
	...
	MAX_ATTRITION_LEADER_REDUCTION = -0.5,			-- Center leader reduces max attrition(reduction in actual percent)
...
NTechnology = {
	BASE_TECH_GROWTH_CHANCE = 0.024, --Base chance of a progress ( 1/10 of a level ) increase
...
NAI =
{
	...
	REVOLT_OTHER_INDEP_RISK = 5,							-- Each ongoing other independence revolt increases revolt risk by this amount for all independence-minded revolters
